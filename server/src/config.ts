...
export const config = {
  ...
  vkApiToken: process.env.VK_API_TOKEN ?? '',
  vkApiVersion: process.env.VK_API_VERSION ?? '5.199',
  vkVerifyRetrySec: toNumber(process.env.VK_VERIFY_RETRY_SEC, 10),
  vkVerifyTimeoutMs: toNumber(process.env.VK_VERIFY_TIMEOUT_MS, 4000),
