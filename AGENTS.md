...
- Любая UI-задача считается завершенной только после визуальной проверки на нескольких мобильных размерах и сравнительной оценки.
...
- В каждом итоговом UI-отчете обязателен блок `Самокритика`:
  - минимум 3 конкретных недочета;
  - что уже исправлено;
  - что остается до 100/100.
...
2. Подготовить промт/мини-ТЗ для согласования:
   ...
   - ограничения;
   - критерий результата;
   - формат проверки (включая скриншоты/оценку для UI).
